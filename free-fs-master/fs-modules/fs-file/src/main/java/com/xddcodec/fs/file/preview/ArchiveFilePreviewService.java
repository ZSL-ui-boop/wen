...
public class ArchiveFilePreviewService {
    ...
    public String previewInnerFile(String archiveFileId, String innerPath, Model model) {
        ...
        try {
            ...
            String innerSuffix = ArchiveUtil.getExtension(fileName).toLowerCase(java.util.Locale.ROOT);
            FileTypeEnum fileType = FileTypeEnum.fromFileInfo(fileName, innerSuffix, fileName);
