...
/**
 * 插件注册器
 * <p>【核心亮点-插件化存储】Java SPI（{@link java.util.ServiceLoader}）+ {@link com.xddcodec.fs.storage.plugin.core.annotation.StoragePlugin}
 * 加载各存储实现，META-INF/services 注册后可热插拔扩展。</p>
 *
 * @Author: xddcode
